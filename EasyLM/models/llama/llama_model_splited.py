...
class FlaxLLaMABlockCollection(nn.Module):
    ...
    def __call__(
        ...
        # print("FlaxLLaMABlockCollection hidden_states", hidden_states)
        for block in self.blocks:
            ...
            # print("FlaxLLaMABlockCollection  after one block hidden_states", hidden_states.shape)

            if output_attentions:
                all_attentions += (layer_outputs[1],)
        # print("FlaxLLaMABlockCollection hidden_states after self.blocks", hidden_states)
...
class FlaxLLaMAModuleClientEmbed(nn.Module):
    ...
    def __call__(
        ...
        hidden_states = self.dropout(input_embeds, deterministic=deterministic)
        # print("FlaxLLaMAModuleClientEmbed hidden_states", hidden_states.dtype, type(hidden_states), hidden_states)
...
class FlaxLLaMAModuleServerEmbed(nn.Module):
    ...
    def __call__(
        ...
        if len(input_ids.shape) == 2:
            ...
            # print("FlaxLLaMAModuleServerEmbed hidden_states", hidden_states)
